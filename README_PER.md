From adamsitnik with modification
...
* [JMeter DLS](https://abstracta.github.io/jmeter-dotnet-dsl/) A simple API for JMeter that enables using you IDE to design and run test using .NET.
